...
CREATE TABLE PLAYLISTS (
    ...
    ORIGIN_USER_NICKNAME VARCHAR2(50),
    ...
    CONSTRAINT FK_PLAYLISTS_USER
        FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID),
    CONSTRAINT FK_PLAYLISTS_ORIGIN
        FOREIGN KEY (ORIGIN_PLAYLIST_ID) REFERENCES PLAYLISTS(PLAYLIST_ID),
...
CREATE TABLE SEARCH_HISTORIES (
    SEARCH_HISTORY_ID NUMBER PRIMARY KEY,
    USER_ID NUMBER NOT NULL,
    SEARCH_QUERY VARCHAR2(255) NOT NULL,
    CREATED_AT TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
    DELETED_AT TIMESTAMP,
...
ON PLAYLIST_TRACKS (SPOTIFY_TRACK_ID, DELETED_AT, PLAYLIST_ID);
...
CREATE INDEX IDX_SEARCH_HISTORIES_USER_CREATED
ON SEARCH_HISTORIES (USER_ID, DELETED_AT, CREATED_AT, SEARCH_HISTORY_ID);
